...
virtual_server[1] = new ObjVirServer("Age of Empires",3);
 ...
 virtual_server[1].entry[2] = new ObjVirtualServer("Age of Empires", true, "Age of Empires", "2300", "2400", "Both", "", "2300", "2400");
 virtual_server[2] = new ObjVirServer("Age of Empires Expansion: The Rise of Rome",3);
 ...
 virtual_server[2].entry[2] = new ObjVirtualServer("Age of Empires Expansion: The Rise of Rome", true, "The Rise of Rome", "2300", "2400", "Both", "", "2300", "2400");
virtual_server[3] = new ObjVirServer("Age of Empires II Expansion: The Conquerors",3);
 ...
 virtual_server[3].entry[2] = new ObjVirtualServer("Age of Empires II Expansion: The Conquerors", true, "The Conquerors", "2300", "2400", "Both", "", "2300", "2400");
 virtual_server[4] = new ObjVirServer("Age of Empires II: The Age of Kings",3);
 ...
 virtual_server[4].entry[2] = new ObjVirtualServer("Age of Empires II: The Age of Kings", true, "The Age of Kings", "2300", "2400", "Both", "", "2300", "2400");
 virtual_server[5] = new ObjVirServer("Age of Kings",3);
 ...
 virtual_server[5].entry[2] = new ObjVirtualServer("Age of Kings", true, "Age of Kings", "2300", "2400", "Both", "", "2300", "2400");
 virtual_server[6] = new ObjVirServer("Age of Wonders",3);
 ...
 virtual_server[6].entry[2] = new ObjVirtualServer("Age of Wonders", true, "Age of Wonders", "2300", "2400", "Both", "", "2300", "2400");
...
virtual_server[8] = new ObjVirServer("Anarchy Online (BETA)",2);
 virtual_server[8].entry[0] = new ObjVirtualServer("Anarchy Online (BETA)", true, "Anarchy Online (BETA)", "7013", "7013", "Both", "", "7013", "7013");
 virtual_server[8].entry[1] = new ObjVirtualServer("Anarchy Online (BETA)", true, "Anarchy Online (BETA)", "7500", "7501", "Both", "", "7500", "7501");
...
virtual_server[11] = new ObjVirServer("Baldur's Gate",1);
 virtual_server[11].entry[0] = new ObjVirtualServer("Baldurs Gate", true, "Baldurs Gate", "47624", "47624", "Both", "", "47624", "47624");
 virtual_server[12] = new ObjVirServer("BattleCom",2);
  virtual_server[12].entry[0] = new ObjVirtualServer("BattleCom", true, "BattleCom", "47624", "47624", "Both", "", "47624", "47624");
  virtual_server[12].entry[1] = new ObjVirtualServer("BattleCom", true, "BattleCom", "2300", "2400", "Both", "", "2300", "2400");
virtual_server[13] = new ObjVirServer("Battlefield Communicator",1);
 virtual_server[13].entry[0] = new ObjVirtualServer("Battlefield Communicator", true, "Battlefield Communicator", "47624", "47624", "Both", "", "47624", "47624");
...
virtual_server[15] = new ObjVirServer("Blizzard Battle.net",2);
 virtual_server[15].entry[0] = new ObjVirtualServer("Blizzard Battle.net", true, "Blizzard Battle.net", "4000", "4000", "TCP", "", "4000", "4000");
 virtual_server[15].entry[1] = new ObjVirtualServer("Blizzard Battle.net", true, "Blizzard Battle.net", "6112", "6112", "Both", "", "6112", "6112");
...
virtual_server[18] = new ObjVirServer("Camerades",1);
 virtual_server[18].entry[0] = new ObjVirtualServer("Camerades", true, "Camerades", "2047", "2048", "Both", "", "2047", "2048");
 virtual_server[19] = new ObjVirServer("CART Precision Racing",3);
 ...
 virtual_server[19].entry[2] = new ObjVirtualServer("CART Precision Racing", true, "CART Precision Racing", "2300", "2400", "Both", "", "2300", "2400");
 virtual_server[20] = new ObjVirServer("Close Combat for Windows",3);
 ...
 virtual_server[20].entry[2] = new ObjVirtualServer("Close Combat for Windows", true, "Close Combat for Windows", "2300", "2400", "Both", "", "2300", "2400");
 virtual_server[21] = new ObjVirServer("Close Combat III: The Russian Front",3);
 ...
 virtual_server[21].entry[2] = new ObjVirtualServer("Close Combat III: The Russian Front", true, "The Russian Front", "2300", "2400", "Both", "", "2300", "2400");
 virtual_server[22] = new ObjVirServer("Close Combat: A Bridge Too Far",3);
 ...
 virtual_server[22].entry[2] = new ObjVirtualServer("Close Combat: A Bridge Too Far", true, "A Bridge Too Far", "2300", "2400", "Both", "", "2300", "2400");
 virtual_server[23] = new ObjVirServer("Combat Flight Simulator 2: WWII Pacific Theater",3);
 ...
 virtual_server[23].entry[2] = new ObjVirtualServer("Combat Flight Simulator 2: WWII Pacific Theater", true, "WWII Pacific Theater", "2300", "2400", "Both", "", "2300", "2400");
virtual_server[24] = new ObjVirServer("Combat Flight Simulator: WWII Europe Series",3);
 ...
 virtual_server[24].entry[2] = new ObjVirtualServer("Combat Flight Simulator: WWII Europe Series", true, "WWII Europe Series", "2300", "2400", "Both", "", "2300", "2400");
...
virtual_server[27] = new ObjVirServer("Dark Reign 2",1);
 virtual_server[27].entry[0] = new ObjVirtualServer("Dark Reign 2", true, "Dark Reign 2", "26214", "26214", "Both", "", "26214", "26214");
...
virtual_server[33] = new ObjVirServer("Diablo I",1);
 virtual_server[33].entry[0] = new ObjVirtualServer("Diablo I", true, "Diablo I", "6112", "6112", "Both", "", "6112", "6112");
...
virtual_server[36] = new ObjVirServer("DirectX 7 Games",2);
 virtual_server[36].entry[0] = new ObjVirtualServer("DirectX 7 Games", true, "DirectX 7 Games", "47624", "47624", "TCP", "", "47624", "47624");
 virtual_server[36].entry[1] = new ObjVirtualServer("DirectX 7 Games", true, "DirectX 7 Games", "2300", "2400", "Both", "", "2300", "2400");
...
virtual_server[38] = new ObjVirServer("Domain Name Server (DNS)",1);
 virtual_server[38].entry[0] = new ObjVirtualServer("Domain Name Server (DNS)", true, "Domain Name Server (DNS)", "53", "53", "Both", "", "53", "53");
virtual_server[39] = new ObjVirServer("Doom",1);
 virtual_server[39].entry[0] = new ObjVirtualServer("Doom", true, "Doom", "666", "666", "Both", "", "666", "666");
...
virtual_server[43] = new ObjVirServer("Everquest",1);
 virtual_server[43].entry[0] = new ObjVirtualServer("Everquest", true, "Everquest", "1024", "6000", "Both", "", "1024", "6000");
...
virtual_server[49] = new ObjVirServer("Fighter Ace II",4);
 virtual_server[49].entry[0] = new ObjVirtualServer("Fighter Ace II", true, "Fighter Ace II", "50000", "50100", "Both", "", "50000", "50100");
 virtual_server[49].entry[1] = new ObjVirtualServer("Fighter Ace II", true, "Fighter Ace II", "47624", "47624", "TCP", "", "47624", "47624");
 virtual_server[49].entry[2] = new ObjVirtualServer("Fighter Ace II", true, "Fighter Ace II", "6073", "6073", "TCP", "", "6073", "6073");
 virtual_server[49].entry[3] = new ObjVirtualServer("Fighter Ace II", true, "Fighter Ace II", "2300", "2400", "Both", "", "2300", "2400");
virtual_server[50] = new ObjVirServer("Flight Simulator 2000",3);
 ...
 virtual_server[50].entry[2] = new ObjVirtualServer("Flight Simulator 2000", true, "Flight Simulator 2000", "2300", "2400", "Both", "", "2300", "2400");
virtual_server[51] = new ObjVirServer("Flight Simulator 98",3);
 ...
 virtual_server[51].entry[2] = new ObjVirtualServer("Flight Simulator 98", true, "Flight Simulator 98", "2300", "2400", "Both", "", "2300", "2400");
...
virtual_server[54] = new ObjVirServer("GNUtella",1);
 virtual_server[54].entry[0] = new ObjVirtualServer("GNUtella", true, "GNUtella", "6346", "6347", "Both", "", "6346", "6347");
virtual_server[55] = new ObjVirServer("Golf 1998 Edition",3);
 ...
 virtual_server[55].entry[2] = new ObjVirtualServer("Golf 1998 Edition", true, "Golf 1998 Edition", "2300", "2400", "Both", "", "2300", "2400");
virtual_server[56] = new ObjVirServer("Golf 1999 Edition",3);
 ...
 virtual_server[56].entry[2] = new ObjVirtualServer("Golf 1999 Edition", true, "Golf 1999 Edition", "2300", "2400", "Both", "", "2300", "2400");
virtual_server[57] = new ObjVirServer("Golf 2001 Edition",3);
 ...
 virtual_server[57].entry[2] = new ObjVirtualServer("Golf 2001 Edition", true, "Golf 2001 Edition", "2300", "2400", "Both", "", "2300", "2400");
...
virtual_server[59] = new ObjVirServer("Half Life",4);
 virtual_server[59].entry[0] = new ObjVirtualServer("Half Life", true, "Half Life", "6003", "6003", "Both", "", "6003", "6003");
 virtual_server[59].entry[1] = new ObjVirtualServer("Half Life", true, "Half Life", "7001", "7001", "Both", "", "7001", "7001");
 virtual_server[59].entry[2] = new ObjVirtualServer("Half Life", true, "Half Life", "27005", "27005", "UDP", "", "27005", "27005");
 virtual_server[59].entry[3] = new ObjVirtualServer("Half Life", true, "Half Life", "27010", "27015", "UDP", "", "27010", "27015");
...
virtual_server[61] = new ObjVirServer("Heretic II Server",1);
 virtual_server[61].entry[0] = new ObjVirtualServer("Heretic II Server", true, "Heretic II Server", "28910", "28910", "Both", "", "28910", "28910");
...
virtual_server[65] = new ObjVirServer("IStreamVideo2HP",1);
 virtual_server[65].entry[0] = new ObjVirtualServer("IStreamVideo2HP", true, "IStreamVideo2HP", "8076", "8077", "Both", "", "8076", "8077");
...
virtual_server[67] = new ObjVirServer("Kohan Immortal Sovereigns",2);
 virtual_server[67].entry[0] = new ObjVirtualServer("Kohan Immortal Sovereigns", true, "Kohan Immortal Sovereigns", "3855", "3855", "Both", "", "3855", "3855");
 virtual_server[67].entry[1] = new ObjVirtualServer("Kohan Immortal Sovereigns", true, "Kohan Immortal Sovereigns", "17437", "17437", "Both", "", "17437", "113");
...
virtual_server[69] = new ObjVirServer("Links 2001",3);
 ...
 virtual_server[69].entry[2] = new ObjVirtualServer("Links 2001", true, "Links 2001", "2300", "2400", "Both", "", "2300", "2400");
...
virtual_server[73] = new ObjVirServer("MechCommander 2.0",3);
 ...
 virtual_server[73].entry[2] = new ObjVirtualServer("MechCommander 2.0", true, "MechCommander 2.0", "2300", "2400", "Both", "", "2300", "2400");
virtual_server[74] = new ObjVirServer("MechWarrior 3",1);
 virtual_server[74].entry[0] = new ObjVirtualServer("MechWarrior 3", true, "MechWarrior 3", "47624", "47624", "Both", "", "47624", "47624");
virtual_server[75] = new ObjVirServer("MechWarrior 4",3);
 ...
 virtual_server[75].entry[2] = new ObjVirtualServer("MechWarrior 4", true, "MechWarrior 4", "2300", "2400", "Both", "", "2300", "2400");
...
virtual_server[77] = new ObjVirServer("Midtown Madness",1);
 virtual_server[77].entry[0] = new ObjVirtualServer("Midtown Madness", true, "Midtown Madness", "47624", "47624", "Both", "", "47624", "47624");
virtual_server[78] = new ObjVirServer("Midtown Madness 2",3);
 ...
 virtual_server[78].entry[2] = new ObjVirtualServer("Midtown Madness 2", true, "Midtown Madness 2", "2300", "2400", "Both", "", "2300", "2400");
...
virtual_server[80] = new ObjVirServer("Monster Truck Madness",3);
 ...
 virtual_server[80].entry[2] = new ObjVirtualServer("Monster Truck Madness", true, "Monster Truck Madness", "2300", "2400", "Both", "", "2300", "2400");
virtual_server[81] = new ObjVirServer("Monster Truck Madness 2",3);
 ...
 virtual_server[81].entry[2] = new ObjVirtualServer("Monster Truck Madness 2", true, "Monster Truck Madness 2", "2300", "2400", "Both", "", "2300", "2400");
virtual_server[82] = new ObjVirServer("Motocross Madness",3);
 virtual_server[82].entry[0] = new ObjVirtualServer("Motocross Madness", true, "Motocross Madness", "47624", "47624", "Both", "", "47624", "47624");
 virtual_server[82].entry[1] = new ObjVirtualServer("Motocross Madness", true, "Motocross Madness", "6073", "6073", "TCP", "", "6073", "6073");
 virtual_server[82].entry[2] = new ObjVirtualServer("Motocross Madness", true, "Motocross Madness", "2300", "2400", "Both", "", "2300", "2400");
virtual_server[83] = new ObjVirServer("Motocross Madness 2",3);   
 ...
 virtual_server[83].entry[2] = new ObjVirtualServer("Motocross Madness 2", true, "Motocross Madness 2", "2300", "2400", "Both", "", "2300", "2400");
virtual_server[84] = new ObjVirServer("Motorhead Server",1);   
 virtual_server[84].entry[0] = new ObjVirtualServer("Motorhead Server", true, "Motorhead Server", "16000", "16000", "Both", "", "16000", "16000");
virtual_server[85] = new ObjVirServer("MSN Gaming Zone",5);
 ...
 virtual_server[85].entry[4] = new ObjVirtualServer("MSN Gaming Zone", true, "MSN Gaming Zone", "2300", "2400", "Both", "", "2300", "2400");
...
virtual_server[96] = new ObjVirServer("Outlaws",1);
 virtual_server[96].entry[0] = new ObjVirtualServer("Outlaws", true, "Outlaws", "5310", "5310", "Both", "", "5310", "5310"); 
virtual_server[97] = new ObjVirServer("pcAnywhere v7.5",1);
 virtual_server[97].entry[0] = new ObjVirtualServer("pcAnywhere v7.5", true, "pcAnywhere v7.5", "5631", "5631", "Both", "", "5631", "5631"); 
virtual_server[98] = new ObjVirServer("PhoneFree",4);
 virtual_server[98].entry[0] = new ObjVirtualServer("PhoneFree", true, "PhoneFree", "1034", "1035", "Both", "", "1034", "1035"); 
 virtual_server[98].entry[1] = new ObjVirtualServer("PhoneFree", true, "PhoneFree", "9900", "9901", "UDP", "", "9900", "9901"); 
 virtual_server[98].entry[2] = new ObjVirtualServer("PhoneFree", true, "PhoneFree", "2644", "2644", "TCP", "", "2644", "2644");
 virtual_server[98].entry[3] = new ObjVirtualServer("PhoneFree", true, "PhoneFree", "8000", "8000", "TCP", "", "8000", "8000");
...
virtual_server[101] = new ObjVirServer("Quake",1);
 virtual_server[101].entry[0] = new ObjVirtualServer("Quake", true, "Quake", "26000", "26000", "Both", "", "26000", "26000");
...
virtual_server[105] = new ObjVirServer("Rise of Rome",1);
 virtual_server[105].entry[0] = new ObjVirtualServer("Rise of Rome", true, "Rise of Rome", "47624", "47624", "Both", "", "47624", "47624");
...
virtual_server[115] = new ObjVirServer("Starfleet Command",3);   
 ...
 virtual_server[115].entry[2] = new ObjVirtualServer("Starfleet Command", true, "Starfleet Command", "2300", "2400", "Both", "", "2300", "2400");
virtual_server[116] = new ObjVirServer("StarLancer",3);   
 ...
 virtual_server[116].entry[2] = new ObjVirtualServer("StarLancer", true, "StarLancer", "2300", "2400", "Both", "", "2300", "2400");
...
virtual_server[125] = new ObjVirServer("Urban Assault",3);
 ...
 virtual_server[125].entry[2] = new ObjVirtualServer("Urban Assault", true, "Urban Assault", "2300", "2400", "Both", "", "2300", "2400"); 
virtual_server[126] = new ObjVirServer("VoxPhone 3.0",1);
 virtual_server[126].entry[0] = new ObjVirtualServer("VoxPhone 3.0", true, "VoxPhone 3.0", "12380", "12380", "Both", "", "12380", "12380"); 
...
virtual_server[130] = new ObjVirServer("Windows 2000 Terminal Server",1);
 virtual_server[130].entry[0] = new ObjVirtualServer("Windows 2000 Terminal Server", true, "Windows 2000 Terminal Server", "3389", "3389", "Both", "", "3389", "3389"); 
virtual_server[131] = new ObjVirServer("X Windows",1);
 virtual_server[131].entry[0] = new ObjVirtualServer("X Windows", true, "X Windows", "6000", "6000", "Both", "", "6000", "6000"); 
...
virtual_server[134] = new ObjVirServer("Pal Talk",3);
 virtual_server[134].entry[0] = new ObjVirtualServer("Pal Talk", true, "Pal Talk", "2090", "2090", "Both", "", "2090", "2090"); 
 virtual_server[134].entry[1] = new ObjVirtualServer("Pal Talk", true, "Pal Talk", "2091", "2091", "Both", "", "2091", "2091");
 virtual_server[134].entry[2] = new ObjVirtualServer("Pal Talk", true, "Pal Talk", "2095", "2095", "TCP", "", "2095", "2095");
...
virtual_server[137] = new ObjVirServer("Netmeeting 2.0, 3.0, Intel Video Phone",2);
 virtual_server[137].entry[0] = new ObjVirtualServer("Netmeeting 2.0, 3.0, Intel Video Phone", true, "Netmeeting 2.0, 3.0, Intel Video Phone", "1503", "1503", "TCP", "", "1503", "1503"); 
virtual_server[137].entry[1] = new ObjVirtualServer("Netmeeting 2.0, 3.0, Intel Video Phone", true, "Netmeeting 2.0, 3.0, Intel Video Phone", "1720", "1720", "TCP", "", "1720", "1720"); 
virtual_server[138] = new ObjVirServer("Westwood Online",2);
 virtual_server[138].entry[0] = new ObjVirtualServer("Westwood Online", true, "Westwood Online", "4000", "4000", "UDP", "", "4000", "4000"); 
 virtual_server[138].entry[1] = new ObjVirtualServer("Westwood Online", true, "Westwood Online", "1140", "1234", "Both", "", "1140", "1234");
...
else if(virtual_server[i].entry[j].type == "Both")
	eval('f.type_'+count).options[2].selected = true;
else	alert(str_908 + "AddVirtualServer");
